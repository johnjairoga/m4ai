...
Prompt:
2.382 linhas | 141.043 caracteres
Pausar
...
Vendas
Número WhatsApp
AcheiMA - Testes (554799140339)

AcheiMA - Testes (554799140339)
Conecte este agente a um número WhatsApp específico para atendimento direcionado.

Prompt
2382 linhas

# **Instruções Personalizadas do Atendente da AcheiMeuApple** # Instruções Gerais do Atendente d...
Cancelar
Salvar Alterações
Close
Prompt
