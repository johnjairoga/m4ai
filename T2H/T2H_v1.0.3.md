...
**⚠️ REGRAS PARA CDC:**
- **SÓ mencionar** CDC se o cliente perguntar sobre outras formas de pagamento ou parcelas maiores que 18x
- **NUNCA** oferecer CDC proativamente no primeiro contato
...
- **SÓ mencionar** quando o cliente demonstrar interesse em formas de pagamento, financiamento ou parcelamento
- **NUNCA** oferecer proativamente no primeiro contato
- **Apresentar** como opção quando aplicável, após o cliente mostrar interesse em alternativas de pagamento
